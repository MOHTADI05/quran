        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-5 md:grid-cols-10 gap-4">
              {juzs.map((juz) => (
                <div
                  key={juz}
                  className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow border-2 border-green-500 hover:border-green-600 cursor-pointer"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-5 md:grid-cols-10 gap-4">
              {Array.from({ length: 60 }, (_, i) => i + 1).map((hizb) => (
                <div
                  key={hizb}
                  className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow border-2 border-blue-500 hover:border-blue-600 cursor-pointer"
                >
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                    {hizb}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">حزب</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-12 bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-center">
              القرآن الكريم مقسم إلى 30 جزء، وكل جزء مقسم إلى حزبين (60 حزب إجمالاً)،
              وكل حزب مقسم إلى أرباع (ربع حزب).
            </p>
          </div>
        </div>
      </main>
